...
public class MusicActivity extends AppCompatActivity implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        mPlayer = MediaPlayer.create(MusicActivity.this, R.raw.music);
